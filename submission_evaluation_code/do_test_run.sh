...
echo "=+= Doing a forward pass (USE_GPUS=${USE_GPUS}, JUDGE_DEVICE=${JUDGE_DEVICE}, JUDGE_DTYPE=${JUDGE_DTYPE}, JUDGE_MAX_NEW_TOKENS=${JUDGE_MAX_NEW_TOKENS}, JUDGE_MODEL_PATH=${JUDGE_MODEL_PATH}, INCLUDE_PER_CASE_RESULTS=${INCLUDE_PER_CASE_RESULTS}, INCLUDE_EVALUATION_DETAILS=${INCLUDE_EVALUATION_DETAILS})"
